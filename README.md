...
簡単なアプリならAIですぐに作れる時代、**「ストアでアプリを探す」よりも「自分で作った方が早い」**ということも起き始めています。
それぐらい、自分の要望に100％合致したアプリというのは見つけるのが難しいです。

私はこれからAI製アプリがどんどんストアに増えていくと、ユーザーはアプリを探すのがさらに大変になって、将来的に個人開発アプリ自体がユーザーから選ばれなくなっていくんじゃないかと思いました。

そこで考えたのは、ユーザーは「ストアで欲しいアプリを探し続けるよりも、自分で欲しいアプリを作れた方が幸せなんじゃないか」ということです。
自分がチート釣り竿を持っている状態でユーザーに魚を売り捌くのは、どこかフェアではないと感じます。
しっかりとユーザーにもチート釣り竿を持たせた上で「自分のよりこのアプリの方が質が良いから使いたい」と言ってもらえるのが理想です。

todome は各ユーザーが自分のローカル環境で自分の理想の形に育てていけるアプリとして設計しています。
アプリを開発プラットフォームとして公開することで「自分のアプリを作る楽しさ」を体験していただこうというのがコンセプトです。
